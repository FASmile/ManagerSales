...
namespace ProjectNhom.TSQLFundamentals2008DataSetTableAdapters {
...
SELECT categoryid, categoryname, description FROM Production.Categories WHERE (categoryid = @categoryid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectNhom.Properties.Settings.Default.TSQLFundamentals2008ConnectionString;
        }
...
SELECT custid, companyname, contactname, contacttitle, address, city, region, postalcode, country, phone, fax FROM Sales.Customers WHERE (custid = @custid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        custid, companyname, contactname, contacttitle, address, city, regi" +
                "on, postalcode, country, phone, fax\r\nFROM            Sales.Customers";
        ...
        public virtual int FillBy(TSQLFundamentals2008DataSet.CustomersDataTable dataTable) {
...
SELECT empid, lastname, firstname, title, titleofcourtesy, birthdate, hiredate, address, city, region, postalcode, country, phone, mgrid FROM HR.Employees WHERE (empid = @empid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT * FROM HR.Employees";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT empid, lastname, firstname, title, titleofcourtesy, birthdate, hiredate, a" +
                "ddress, city, region, postalcode, country, phone, mgrid FROM HR.Employees";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FAS(TSQLFundamentals2008DataSet.EmployeesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int Hai(TSQLFundamentals2008DataSet.EmployeesDataTable dataTable) {
